...
if __name__ == "__main__":
    ...
    # Define the average hours per UCP (this can be adjusted based on historical data or industry standards)
    # A common industry average is around 20 hours/UCP, but it varies greatly by project and team.
    HOURS_PER_UCP = 50.0
    ...
    if ucp_data:
        ...
        estimated_effort = calculate_estimated_effort(ucp, HOURS_PER_UCP)
        print(f"\nEstimated Effort (at {HOURS_PER_UCP} Hours/UCP): {estimated_effort:.2f} hours")
